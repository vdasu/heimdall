...
# 115 C eBPF programs, producing Aya Rust translations and verifying each
...
# Full 115-program canonical set (matches paper_scripts/analyze_agent_sessions.py).
PROGRAMS=(
    ...
    "c_bpf_programs/KEN/dataset/libbpf|bashreadline.bpf.c|bashreadline.bpf.o|ken_libbpf__|events:perf_event_array"
    ...
    "c_bpf_programs/KEN/dataset/libbpf|opensnoop.bpf.c|opensnoop.bpf.o|ken_libbpf__|heap:percpu_array events:ringbuf start:hash"
    ...
    "c_bpf_programs/libbpf-tools|bindsnoop.bpf.c|bindsnoop.o|libbpf_tools__|cgroup_map:cgroup_array sockets:hash ports:hash events:perf_event_array"
    "c_bpf_programs/libbpf-tools|biolatency.bpf.c|biolatency.o|libbpf_tools__|cgroup_map:cgroup_array start:hash hists:hash"
    "c_bpf_programs/libbpf-tools|biopattern.bpf.c|biopattern.o|libbpf_tools__|counters:hash"
    "c_bpf_programs/libbpf-tools|biosnoop.bpf.c|biosnoop.o|libbpf_tools__|cgroup_map:cgroup_array infobyreq:hash start:hash events:perf_event_array"
    ...
    "c_bpf_programs/libbpf-tools|capable.bpf.c|capable.o|libbpf_tools__|start:hash cgroup_map:cgroup_array events:perf_event_array stackmap:stack_trace info:hash seen:hash"
    "c_bpf_programs/libbpf-tools|cpudist.bpf.c|cpudist.o|libbpf_tools__|cgroup_map:cgroup_array start:hash hists:hash"
    "c_bpf_programs/libbpf-tools|cpufreq.bpf.c|cpufreq.o|libbpf_tools__|cgroup_map:cgroup_array hists:hash"
    "c_bpf_programs/libbpf-tools|drsnoop.bpf.c|drsnoop.o|libbpf_tools__|start:hash events:perf_event_array"
    "c_bpf_programs/libbpf-tools|execsnoop.bpf.c|execsnoop.o|libbpf_tools__|cgroup_map:cgroup_array execs:hash events:perf_event_array"
    "c_bpf_programs/libbpf-tools|exitsnoop.bpf.c|exitsnoop.o|libbpf_tools__|cgroup_map:cgroup_array events:perf_event_array"
    ...
    "c_bpf_programs/libbpf-tools|funclatency.bpf.c|funclatency.o|libbpf_tools__|cgroup_map:cgroup_array starts:hash"
    ...
    "c_bpf_programs/libbpf-tools|hardiqs.bpf.c|hardiqs.o|libbpf_tools__|cgroup_map:cgroup_array start:percpu_array infos:hash"
    ...
    "c_bpf_programs/libbpf-tools|runqlat.bpf.c|runqlat.o|libbpf_tools__|cgroup_map:cgroup_array start:hash hists:hash"
    ...
    "c_bpf_programs/libbpf-tools|syscount.bpf.c|syscount.o|libbpf_tools__|cgroup_map:cgroup_array start:hash data:hash"
    ...
    "c_bpf_programs/libbpf-tools|tcptop.bpf.c|tcptop.o|libbpf_tools__|cgroup_map:cgroup_array ip_map:hash"
