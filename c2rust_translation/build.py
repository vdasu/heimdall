...
_AYA_DIR = os.environ.get("AYA_BUILD_DIR", "./aya-ebpf").rstrip("/")
RUST_SRC_PATH = f"{_AYA_DIR}/src/main.rs"
RUST_BUILD_DIR = _AYA_DIR
RUST_BUILD_LOG = f"{_AYA_DIR}/build.log"
RUST_OBJ_SRC = f"{_AYA_DIR}/target/bpfel-unknown-none-atomic/release/aya-ebpf-translated"
RUST_OBJ_DST = os.environ.get("AYA_OBJ_DST", "aya-tracepoint-obj")
