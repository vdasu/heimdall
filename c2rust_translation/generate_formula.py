...
def generate_formula_for_program(
    ...
    _mem_fill = (angr.options.SYMBOL_FILL_UNCONSTRAINED_MEMORY if symbolic_uninit
                 else angr.options.ZERO_FILL_UNCONSTRAINED_MEMORY)
    state = project.factory.blank_state(
        addr=start_addr,
        add_options={_mem_fill},
    )
